...
var chunks = {
    ...
    cube_uv_reflection_fragment: require('../Chunks/cube_uv_reflection_fragment.glsl'),
    lights_pars_begin: require('../Chunks/lights_pars_begin.glsl'),
    lights_pars_maps: require('../Chunks/lights_pars_maps.glsl'),
    lights_physical_pars_fragment: require('../Chunks/lights_physical_pars_fragment.glsl'),
    ...
    roughnessmap_pars_fragment: require('../Chunks/roughnessmap_pars_fragment.glsl'),
    metalnessmap_pars_fragment: require('../Chunks/metalnessmap_pars_fragment.glsl'),
    ...
    roughnessmap_fragment: require('../Chunks/roughnessmap_fragment.glsl'),
    metalnessmap_fragment: require('../Chunks/metalnessmap_fragment.glsl'),
    ...
    lights_physical_fragment: require('../Chunks/lights_physical_fragment.glsl'),
