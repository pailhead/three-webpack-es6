...
var chunks = {
    ...
    lights_lambert_vertex: require('../Chunks/lights_lambert_vertex.glsl'),
    ...
    shadowmask_pars_fragment: require('../Chunks/shadowmask_pars_fragment.glsl'),
    ...
    lightmap_fragment: require('../Chunks/lightmap_fragment.glsl'),
